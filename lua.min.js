(function(){function D(d){return z[/\.\/(\w*)\.js/.exec(d)[1]]}var z={lex:{},parser:{},codegen:{},types:{},index:{}};(function(d){function c(c){return e.test(c)}function v(e){return"\n"==e||"\r"==e}function g(e,c,g){var d=0,k=e();if("["!=k&&"]"!=k)throw"Lexical internal error!";g&&g(k);for(c();"="==e();)c(),g&&g(e()),++d;return e()==k?d:-d-1}function k(e,c){var g=e();c();v(e())&&e()!=g&&c()}function l(e,c,d){function h(e){l.push(e)}var l=[];c();for(v(e())&&k(e,c);;){var m=e();switch(m){case null:throw"unfinished long string/comment";
case "]":if(g(e,c,h)==d)return c(),l.splice(-d-1,d+1),l.join("");break;case "\n":case "\r":k(e,c);h("\n");break;default:h(m),c()}}}function h(e,u){for(;;)switch(e()){case "\n":case "\r":case " ":case "\f":case "\t":case "\v":u();break;case "-":u();if("-"!=e())return"-";u();var d=e();if("["==d){var h=g(e,u);if(0<=h){l(e,u,h);break}}for(;d&&"\n"!=d&&"\r"!=d;)u(),d=e();break;case "[":h=g(e,u);if(0<=h)return{id:w.TK_STRING,val:l(e,u,h)};if(-1==h)return"[";throw"invalid long string delimiter";case "=":u();
if("="!=e())return"=";u();return w.TK_EQ;case "<":u();if("="!=e())return"<";u();return w.TK_LE;case ">":u();if("="!=e())return">";u();return w.TK_GE;case "~":u();if("="!=e())return"~";u();return w.TK_NE;case ":":u();if(":"!=e())return":";u(ls);return w.TK_DBCOLON;case '"':case "'":var d=w.TK_STRING,h=e,n=u,x=[],A=h();n();for(var v=void 0;(v=h())!=A;)switch(v){case null:throw"unfinished string";case "\n":case "\r":throw"unfinished string";case "\\":n();v=h();switch(v){case "b":x.push("\b");n();break;
case "f":x.push("\f");n();break;case "n":x.push("\n");n();break;case "r":x.push("\r");n();break;case "t":x.push("\t");n();break;case "v":x.push("\v");n();break;case "\n":case "\r":x.push("\n");k();break;case "\\":case '"':case "'":x.push(v);n();break;case null:throw"unfinished string";case "z":for(n();lisspace(h());)n();break;case "x":throw"esacpe for char code not supported in lua.js yet.";default:if(!m.test(v))throw"invalid escape sequence"+v;throw"esacpe for char code not supported in lua.js yet.";
}break;default:x.push(v),n()}n();h=x.join("");return{id:d,val:h};case ".":u();if("."==e())return u(),"."==e()?(u(),w.TK_DOTS):w.TK_CONCAT;d=e();if(!m.test(d))return".";case "0":case "1":case "2":case "3":case "4":case "5":case "6":case "7":case "8":case "9":d=w.TK_NUMBER;h=e;n=u;x=h();n();if("0"!=x||"x"!=h()&&"X"!=h()){x=[x];for(A=h();m.test(A)||"."==A;)x.push(A),n(),A=h();h=parseFloat(x.join(""))}else throw n(),Error("Hexadecimal numeric not supported in lua.js yet.");return{id:d,val:h};case null:return w.TK_EOS;
default:d=e();if(B.test(d)){d=e;h=u;for(n=[];c(d());)n.push(d()),h();d=n.join("");return(h="number"==typeof r[d]&&r[d])?h:{id:w.TK_NAME,val:d}}d=e();u();return d}}function n(e){function c(){return d<e.length?e.charAt(d):null}function g(){d<e.length&&++d}var d=0;return function(){return h(c,g)}}d.tokens="<eof> and break do else elseif end false for function goto if in local nil not or repeat return then true until while .. ... == >= <= ~= :: <--orgion-eof> <number> <name> <string> __javascript __jsreturn".split(" ");
...
{type:"vararg"};case "{":return x(g);case q.TK_FUNCTION:return g.next(),z(g);default:return e(g)}}function y(e,c){var g,d;a:{switch(e.curr()){case q.TK_NOT:d="uop.not";break a;case "-":d="uop.minus";break a;case "#":d="uop.len";break a}d=void 0}d?(e.next(),g=y(e,M),g={type:"expr.uop",op:d,operand:g}):g=u(e);for(d=p(e);d&&J[d][0]>c;){e.next();var h=y(e,J[d][1]);g={type:"expr.op",op:K[d],left:g,right:h};d=p(e)}return g}function E(e){var c=[];for(c.push(y(e,0));k(e,",");)c.push(y(e,0));return c}function H(e){var g;
...
";"==e.curr()||(g.nret=E(e));for(;k(e,";"););return g}function I(c){switch(c.curr()){case ";":c.next();break;case q.TK_IF:var p={type:"stat.if"},d=p;c.next();var u=d;u.cond=y(c,0);h(c,q.TK_THEN);for(u.tblock=C(c);k(c,q.TK_ELSEIF);){d.fblock={type:"block",stats:[{type:"stat.if"}]};var d=d.fblock.stats[0],u=c,l=d;l.cond=y(u,0);h(u,q.TK_THEN);l.tblock=C(u)}k(c,q.TK_ELSE)&&(d.fblock=C(c));h(c,q.TK_END);return p;case q.TK_WHILE:return c.next(),p=y(c,0),h(c,q.TK_DO),d=C(c),h(c,q.TK_END),{type:"stat.while",
cond:p,block:d};case q.TK_DO:return c.next(),p=C(c),h(c,q.TK_END),p;case q.TK_FOR:c.next();d=n(c);switch(c.curr()){case "=":c.next();u=y(c,0);h(c,",");l=y(c,0);k(c,",")&&(p=y(c,0));p={type:"stat.fornum",varname:d,from:u,to:l,step:p};break;case ",":case q.TK_IN:for(p=[d];k(c,",");)p.push(n(c));h(c,q.TK_IN);p={type:"stat.forlist",varnames:p,explist:E(c)};break;default:throw"`=` or `in` expected";}h(c,q.TK_DO);p.block=C(c);h(c,q.TK_END);return p;case q.TK_REPEAT:return c.next(),p=C(c),h(c,q.TK_UNTIL),
...
[];!L(e);){if(e.curr()==q.TK_RETURN||e.curr()==q.TK_JSRETURN){c.push(I(e));break}var p=I(e);p&&c.push(p)}return{type:"block",stats:c}}function z(e){h(e,"(");var p=[];if(")"!=e.curr()){do switch(c(e.curr())){case q.TK_NAME:p.push(n(e));break;case q.TK_DOTS:p.push(q.TK_DOTS);e.next();break;default:throw"<name> or `...` expected";}while(k(e,","))}var g=!1;0<p.length&&p[p.length-1]==q.TK_DOTS&&(p.pop(),g=!0);h(e,")");var d=C(e);h(e,q.TK_END);return{type:"function",args:p,varargs:g,block:d}}var G=D("./lex.js"),
...
e.type?l(e):"l.__checknumber("+g(e)+")"}function v(e){if("vararg"==e.type||"expr.call"==e.type||"expr.callMethod"==e.type)return!0}function g(e){return v(e)?"("+l(e)+")[0]":l(e)}function k(e){if(e.length&&v(e[e.length-1])){if(1==e.length)return l(e[0]);for(var c=[],d=0;d<e.length-1;d++)c.push(g(e[d]));return"["+c.join(",")+"].concat("+l(e[e.length-1])+")"}c=[];for(d=0;d<e.length;d++)c.push(g(e[d]));return"["+c.join(",")+"]"}function l(e){if(n[e.type])return n[e.type](e);throw Error("Unsupported ast type "+
e.type);}function h(e,c){return function(g){function d(g,u){if(g&&g.constructor==Array){for(var h=0;h<g.length;h++)g[h]=d(g[h],u);return g}if(g&&g.type){var k=e(g,u)||g,l=m[k.type];if(l)for(h=0;h<l.length;h++)k[l[h]]=d(k[l[h]],k);c&&(k=c(k,u)||k);return k}}return d(g)}}var n={},r,w,B;r="\n";w=function(){r+="    "};B=function(){r=r.substr(0,r.length-4)};n["function"]=function(e){return"l._f(function("+e.args.join(",")+")"+l(e.block)+")"};n.block=function(e){var c=[];w();for(var g=0;g<e.stats.length;g++)c.push(l(e.stats[g]));
...
}};n["expr.call"]=function(e){return"l.__call("+g(e.func)+","+k(e.args)+")"};n["expr.callMethod"]=function(e){return"l.__callMethod("+g(e.self)+","+g(e.key)+","+k(e.args)+")"};n["expr.brackets"]=function(e){return v(e.expr)?g(e.expr):"("+l(e.expr)+")"};n["expr.constructor"]=function(e){if(!e.fields.length)return"l.__newTable()";for(var c=[],d=0;d<e.fields.length;d++){var h=e.fields[d];if("field.list"==h.type)v(h.val)&&d==e.fields.length-1?c.push("[2, "+l(h.val)+"]"):c.push("[0, "+g(h.val)+"]");else if("field.rec"==
...
e+";"})})()})(z.codegen);(function(d){function c(){this._hashKey=-2;this.toString=function(){return""}}function v(c){this.stringMap={};this.array=[];this.hashMap={};this.metatable=null;this._hashKey=++l;if(c)for(var g=0;g<c.length;g++){var d=c[g];if(0==d[0])this.array.push(d[1]);else if(1==d[0])this.set(d[1],d[2]);else for(var k=0;k<d[1].length;k++)this.array.push(d[1][k])}}var g={_hashKey:-1,valueOf:function(){return 0},toString:function(){return"0"}};c.prototype=String.prototype;var k=new c;d.dummy0=
g;d.dummyStr=k;var l=0;d.LuaTable=v;d.newHashKey=function(){return++l};v.prototype={};v.prototype.constructor=v;v.prototype.get=function(c){switch(typeof c){case "number":return this.array[c-1];case "string":return this.stringMap[c];case "object":if(c===g)return this.array[-1];if(c===k)return this.stringMap[c];if(null===c)throw Error("table index is nil");case "function":return c._hashKey||(c._hashKey=++l),(c=this.hashMap[c._hashKey])&&c[1];default:throw Error("get with a invalid argument"+c);}};
v.prototype.set=function(c,g){if(null==c)throw Error("table index is nil");if(null==g)switch(typeof c){case "number":c==this.array.length?this.array.pop():delete this.array[c-1];break;case "string":delete this.stringMap[c];break;case "object":case "function":if(!c._hashKey)break;delete this.hashMap[c._hashKey];break;default:throw Error("set with a invalid argument"+c);}else switch(typeof c){case "number":this.array[c-1]=g;break;case "string":this.stringMap[c]=g;break;case "object":case "function":c._hashKey||
(c._hashKey=++l);this.hashMap[c._hashKey]=[c,g];break;default:throw Error("set with a invalid argument"+c);}};v.prototype.length=function(){for(var c=this.array.length;0<c&&null==this.array[c-1];--c);c!=this.array.length&&(this.array.length=c);return this.array.length};v.prototype.toString=function(){return"table "+this._hashKey}})(z.types);(function(d){function c(c){return c.substr(0,l.length)!=l?k.run(g.parse(c)):c}function v(){function g(e,c){var d=m.__getmetatable(e);return d&&d.stringMap&&d.stringMap[c]}
if(!(this instanceof v))return new v;var l=new h.LuaTable;this._G=l;l.set("_G",l);l.set("_VERSION","Lua 5.2");l.set("_LUAJS","Lua.js 0.1");var m={};m.d0=n;m.ds=r;m.__getmetatable=function(e){if(!e)return null;switch(typeof e){case "object":return e.metatable||(e instanceof h.LuaTable?null:m.jsObjMT);case "string":return m.stringMT;case "function":if(!f.__lua_function)return m.jsFuncMT;default:return null}};m._f=function(e){e.__lua_function=!0;return e};m.__get=function(e,c){var d;if(e instanceof h.LuaTable){if(d=
...
arguments[d];return 0!=c});c.__set(d,"io",c.__newTable());c.__set(c.__get(d,"io"),"write",function(c){"\n"!=c&&console.log(c)});c.__set(c.__get(d,"io"),"flush",c._f(function(){return[]}));c.__set(d,"os",c.__newTable());c.__set(c.__get(d,"os"),"clock",function(){var c=Date.now();return function(){return(Date.now()-c)/1E3}}());c.__set(c.__get(d,"os"),"difftime",c._f(function(d,k){return[c.__sub(d,k)]}));c.__set(c.__get(d,"os"),"time",function(){return Date.now()/1E3});return[]})};window.luajs=z.index;
(function(){function d(c,d){var g=window.XMLHttpRequest?new XMLHttpRequest:new ActiveXObject("Microsoft.XMLHTTP");g.addEventListener("readystatechange",function(){if(4==g.readyState){if(200!=g.status&&0!=g.status)throw Error("HTTP "+g.status+": "+c);console.info("Loaded: ",c);d(g.responseText)}});g.open("GET",c,!0);g.send()}function c(k,l){l=l||0;if(!(l>=k.length)){var h=k[l];h.code?(g.loadString(h.code)("embedded"),c(k,l+1)):d(h.src,function(d){g.loadString(d)(h.src);c(k,l+1)})}}function v(){for(var d=
window.document.getElementsByTagName("script"),g=[],h=0;h<d.length;h++){var n=d[h];if("text/lua"==n.type||"application/x-lua"==n.type)n.src?g.push({src:n.src}):g.push({code:n.innerHTML})}c(g)}var g=luajs.newContext();g.loadStdLib();g._G.metatable=new luajs.types.LuaTable([[1,"__index",window]]);window.addEventListener?window.addEventListener("DOMContentLoaded",v,!1):window.attachEvent("onload",v)})()})();
