...
e.get(c))return d;d=g(e,"__index");if(!d)return null}else{if("object"==typeof e||"function"==typeof e&&!e.__lua_function){if("function"==typeof e)for(;e.__beforeBind;)e=e.__beforeBind;d="number"==typeof c?e[c-1]:e[c];if("function"==typeof d)return d=d.bind(e),d.__beforeBind=d;if(!d&&"new"==c){var k=function(){};k.prototype=e.prototype;return function(){var e=new k;t.apply(e,arguments);return e}}return d}d=g(e,"__index");if(!d)throw Error("attempt to index a "+m.__type(e)+" value.");}return"function"==
