...
e.get(c))return d;d=g(e,"__index");if(!d)return null}else{if("object"==typeof e||"function"==typeof e&&!e.__lua_function){d="number"==typeof c?e[c-1]:e[c];if("function"==typeof d)return d.bind(e);if(!d&&"new"==c){var k=function(){};k.prototype=e.prototype;return function(){var e=new k;t.apply(e,arguments);return e}}return d}d=g(e,"__index");if(!d)throw Error("attempt to index a "+m.__type(e)+" value.");}return"function"==typeof d?m.__call(d,[e,c])[0]:m.__get(d,c)};m.__set=function(e,c,d){var k;if(e instanceof
h.LuaTable){if(e.get(c)){e.set(c,d);return}k=g(e,"__newindex");if(!k){e.set(c,d);return}}else{if("object"==typeof e||"function"==typeof e&&!e.__lua_function){e[c]=d;return}k=g(e,"__newindex");if(!k)throw Error("attempt to index a "+m.__type(e)+" value.");}"function"==typeof k?m.__call(k,[e,c,d]):m.__set(k,c,d)};m.__add=function(e,c){if("number"==typeof e&&"number"==typeof c)return e+c||n;var d=m.__tonumber(e),k=m.__tonumber(c);if(d&&k)return e+c||n;if(d=g(e,"__add")||g(c,"__add"))return m.__call(d,
[e,c])[0];throw Error("attempt to perform arithmetic on a "+m.__type(e)+" value");};m.__sub=function(e,c){if("number"==typeof e&&"number"==typeof c)return e-c||n;var d=m.__tonumber(e),k=m.__tonumber(c);if(d&&k)return e-c||n;if(d=g(e,"__sub")||g(c,"__sub"))return m.__call(d,[e,c])[0];throw Error("attempt to perform arithmetic on a "+m.__type(e)+" value");};m.__mul=function(e,c){if("number"==typeof e&&"number"==typeof c)return e*c||n;var d=m.__tonumber(e),k=m.__tonumber(c);if(d&&k)return e*c||n;if(d=
g(e,"__mul")||g(c,"__mul"))return m.__call(d,[e,c])[0];throw Error("attempt to perform arithmetic on a "+m.__type(e)+" value");};m.__div=function(e,c){if("number"==typeof e&&"number"==typeof c)return e/c||n;var d=m.__tonumber(e),k=m.__tonumber(c);if(d&&k)return e/c||n;if(d=g(e,"__div")||g(c,"__div"))return m.__call(d,[e,c])[0];throw Error("attempt to perform arithmetic on a "+m.__type(e)+" value");};m.__mod=function(e,c){if("number"==typeof e&&"number"==typeof c)return e%c||n;var d=m.__tonumber(e),
k=m.__tonumber(c);if(d&&k)return e%c||n;if(d=g(e,"__mod")||g(c,"__mod"))return m.__call(d,[e,c])[0];throw Error("attempt to perform arithmetic on a "+m.__type(e)+" value");};m.__pow=function(e,c){if("number"==typeof e&&"number"==typeof c)return Math.pow(e,c)||n;var d=m.__tonumber(e),k=m.__tonumber(c);if(d&&k)return Math.pow(e,c)||n;if(d=g(e,"__pow")||g(c,"__pow"))return m.__call(d,[e,c])[0];throw Error("attempt to perform arithmetic on a "+m.__type(e)+" value");};m.__unm=function(e){var c=m.__tonumber(e);
if(c)return-c;if(c=g(e).__unm)return m.__call(c,[e])[0];throw Error("attempt to perform arithmetic on a "+m.__type(e)+" value");};m.__eq=function(e,c){return!m.__neq(e,c)};m.__neq=function(e,c){if(e===c)return!1;var d=m.__type(e),k=m.__type(c);if(d!=k||"table"!=d&&"userdata"!=d)return!0;d=g(e,"__eq");k=g(c,"__eq");return d&&d==k?!m.__call(d,[e,c])[0]:!0};m.__gt=function(e,c){return m.__lt(c,e)};m.__ge=function(c,g){return m.__le(g,c)};m.__lt=function(c,d){var k=m.__type(c),h=m.__type(d);if("number"==
k&&"number"==h||"string"==k&&"string"==h)return c<d;if(g(c,"__lt")||g(c,"__lt"))return!!m.__call(h1,[c,d])[0];throw Error("attempt to compare "+m.__type(c)+" with "+m.__type(d));};m.__le=function(c,d){var k=m.__type(c),h=m.__type(d);if("number"==k&&"number"==h||"string"==k&&"string"==h)return c<=d;if(k=g(c,"__le")||g(c,"__le"))return!!m.__call(h1,[c,d])[0];if(k=g(c,"__lt")||g(c,"__lt"))return!m.__call(h1,[c,d])[0];throw Error("attempt to compare "+m.__type(c)+" with "+m.__type(d));};m.__concat=function(c,
d){var k=m.__type(c),h=m.__type(d);if(!("number"!=k&&"string"!=k||"number"!=h&&"string"!=h))return""+c+d||r;if(g(c,"__concat")||g(d,"__concat"))return m.__call(h1,[c,d])[0];throw Error("attempt to concatenate a "+m.__type(c)+" value");};m.__newTable=function(c){return new h.LuaTable(c)};m.__len=function(c){switch(typeof c){case "string":return c.length}var d=g(c,"__len");if(d)return m.__call(d,[a])[0];if(c instanceof h.LuaTable)return c.length();if("object"==typeof c&&c.length)return c.length;throw Error("attempt to get length of a "+
m.__type(c)+" value");};m.__tonumber=function(c){switch(typeof c){case "number":return c;case "string":return parseInt(s)||n;default:if(c==n)return c}return null};m.__checknumber=function(c){switch(typeof c){case "number":return c;case "string":return parseInt(s)}if(c==n)return c;throw Error("Not a number.");};m.__tostring=function(c){if(null==c)return"nil";switch(typeof c){case "number":case "boolean":return c.toString();case "string":return c;case "function":return c._hashKey=c._hashKey||h.newHashKey(),
"function("+c._hashKey+")";case "object":if(c==n)return"0";if(c==r)return r;var d=g(c,"__tostring");if(d)return m.__call(d,[c])[0];if(c.toString)return c.toString();default:return"userdata("+c+")"}};m.__type=function(c){if(null==c)return"nil";var d=typeof c;switch(d){case "number":case "boolean":case "string":case "function":return d;case "object":if(c==n)return"number";if(c==r)return r;if(c instanceof h.LuaTable)return"table";default:return"userdata"}};m.__call=function(c,d){if("function"==typeof c)return c.__lua_function?
c.apply(null,d):[c.apply(null,d)];var k=g(c,"__call");if(k)return d.unshift(k),m.__call(k,d);throw Error("attempt to call a "+m.__type(c)+" value");};m.__callMethod=function(c,d,g){g.unshift(c);return m.__call(m.__get(c,d),g)};m.__dump=function(c){if("function"!=typeof c)throw Error("bad argument #1 to `dump` (function expected, got "+m.__type(c)+")");return k.sign+"return "+c.toString()+";"};this.loadString=m.__loadString=function(e,d){e=c(e);return(new Function("_ENV","l",e))(d||l,m)};this.loadStdLib=
function(){if(!d.stdlib){var c=D("fs"),g=D("path"),c=c.readFileSync(g.join(g.dirname(module.filename),"./stdlib.lua"),{encoding:"utf-8"});d.stdlib=new Function("_ENV","l",d.compile(c))}d.stdlib(l,m)()}}var g=D("./parser.js");d.parser=g;var k=D("./codegen.js");d.codegen=k;var l=k.sign;d.compile=c;var h=D("./types.js");d.types=h;var n=h.dummy0,r=h.dummyStr;u.prototype={};d.LuaContext=d.newContext=u})(z.index);z.index.stdlib=function(d,c){return c._f(function(){Array.prototype.slice.call(arguments,0);
c.__set(d,"assert",c._f(function(g,k){g||c.__call(c.__get(d,"error"),[k||"Assertion failed!"]);return[]}));c.__set(d,"collectgarbage",c._f(function(){return[]}));var u;u=c._f(function(g){c.__call(c.__get(d,"error"),["Not implemented"]);return[]});c.__set(d,"dofile",u);c.__set(d,"error",function(c){if("string"==typeof c)throw Error(c);throw c;});c.__set(d,"getmetatable",function(c){return c&&c.metatable});c.__set(d,"ipairs",c._f(function(d){return[c._f(function(d,g){return c.__ge(g,c.__len(d))?[]:
[c.__add(g,1),c.__get(d,c.__add(g,1))]}),d,c.d0]}));c.__set(d,"loadString",function(d,k){return c.__loadString(d,k)});c.__set(d,"load",c._f(function(g,k,l,h){if(c.__eq(c.__call(c.__get(d,"type"),[g])[0],"function")){k=c.__newTable();for(g=[g];;){l=g[0](g[1],g[2])[0];if(null==l)break;g[2]=l;c.__call(c.__get(c.__get(d,"table"),"insert"),[c.__get(d,"chunk"),l])}g=c.__call(c.__get(c.__get(d,"table"),"concat"),[k])[0]}return c.__call(c.__get(d,"loadString"),[g,h])}));c.__set(d,"loadfile",u);c.__set(d,
"next",u);c.__set(d,"pairs",u);c.__set(d,"pcall",c._f(function(d){var k=Array.prototype.slice.call(arguments,1);try{var l=c.__call(d,k);l.unshift(!0);return l}catch(h){return[!1,h]}}));c.__set(d,"print",c._f(function(){for(var g=Array.prototype.slice.call(arguments,0),g=c.__newTable([[2,g]]),k,l=1,h=c.__checknumber(c.__len(g));(k=l)<=h;++l)c.__set(g,k,c.__call(c.__get(d,"tostring"),[c.__get(g,k)])[0]);c.__call(c.__get(c.__get(d,"io"),"write"),c.__call(c.__get(c.__get(d,"table"),"concat"),[g," "]));
c.__call(c.__get(c.__get(d,"io"),"write"),["\n"]);return[]}));c.__set(d,"rawequal",function(c,d){return c===d});c.__set(d,"rawget",function(d,k){var l=c.__type(d);if("table"!=l)throw Error("rawget called with type "+l);return d.get(k)});c.__set(d,"rawlen",function(d){var k=c.__type(d);if("table"!=k)throw Error("rawlen called with type "+k);return d.length()});c.__set(d,"rawset",function(d,k,l){var h=c.__type(d);if("table"!=h)throw Error("rawget called with type "+h);d.set(k,l);return d});c.__set(d,
"select",function(c){return"#"==c?arguments.length:arguments[c]});c.__set(d,"setmetatable",function(c,d){if("object"!=typeof c)throw Error("Cannot set metatable to non-object values.");c.metatable=d});c.__set(d,"tonumber",c.__tonumber);c.__set(d,"tostring",c.__tostring);c.__set(d,"type",c.__type);c.__set(d,"xpcall",function(d,k){var l=Array.prototype.slice.call(arguments,2);try{return c.__call(d,l)}catch(h){return c.__call(k,[h])}});c.__set(d,"package",c.__newTable());c.__set(c.__get(d,"package"),
"loaded",c.__newTable());c.__set(c.__get(d,"package"),"preload",c.__newTable());c.__set(d,"require",c._f(function(g){var k=c.__get(c.__get(c.__get(d,"package"),"loaded"),g);if(k)return[k];for(var l,h,k=c.__call(c.__get(d,"ipairs"),[c.__get(c.__get(d,"package"),"searchers")]);;){var n=k[0](k[1],k[2]),r=n[0],n=n[1];if(null==r)break;k[2]=r;n=c.__call(n,[g]);l=n[0];h=n[1];if(l)break}l=c.__call(l,[g,h])[0];c.__set(c.__get(c.__get(d,"package"),"loaded"),g,c.__get(c.__get(c.__get(d,"package"),"loaded"),
g)||l);return[c.__get(c.__get(c.__get(d,"package"),"loaded"),g)]}));c.__set(d,"string",c.__newTable());c.stringMT=c.__get(d,"string");c.__set(c.__get(d,"string"),"byte",c._f(function(d,k,l){if("string"!=typeof d&&(d=c.__tostring(d),d==c.ds))return[];k=k||1;l=l||k;0>k?k=d.length+k:k--;0>l&&(l=d.length+l+1);for(var h=[];k<l;++k){var n=d.charCodeAt(k);n&&h.push(n)}return h}));c.__set(c.__get(d,"string"),"dump",c.__dump);c.__set(c.__get(d,"string"),"find",function(c,d,l,h){if(h)return c.indexOf(d,l&&
l-1)+1;throw Error("Not implemented.");});c.__set(c.__get(d,"string"),"len",function(d){"string"!=typeof d&&d!=c.ds&&(d=c.__tostring(d));return d==c.ds?0:d.length});c.__set(c.__get(d,"string"),"lower",function(d){"string"!=typeof d&&d!=c.ds&&(d=c.__tostring(d));return d==c.ds?d:d.toLowerCase()});c.__set(c.__get(d,"string"),"upper",function(d){"string"!=typeof d&&d!=c.ds&&(d=c.__tostring(d));return d==c.ds?d:d.toUpperCase()});c.__set(c.__get(d,"string"),"rep",function(c,d,l){return l?Array(d).join(c+
